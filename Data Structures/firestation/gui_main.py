...
from gui.firestation_mw import Ui_FireStationMW

#Import main application:
from firestation.guimain import GUIMain
...
if __name__ == '__main__':
    if parsed_args.about == True:
        ...
        print("FireStation Demo, V1.0. CSCI211 Linked List Object Sorting GUI Exercise by D. Mann");
        sys.exit()
